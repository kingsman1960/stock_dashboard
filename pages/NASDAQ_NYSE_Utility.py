...
st.title("NASDAQ NYSE Utility Dashboard")

st.markdown("This streamlit application is using for"
            "monitoring NASDAQ NYSE Utility companies with upperthan medium market Cap (> $ 2 Bil) \n By Youngwon Cho.")
...
DATA_URL3 = "./pages/nasdaq_nyse_utility.csv"
#tickers = pd.read_csv()
