...
st.title("NASDAQ NYSE Industial Sector Dashboard")

st.markdown("This streamlit application is using for"
            "monitoring NASDAQ NYSE Industial companies with upperthan medium market Cap (> $ 2 Bil) \n By Youngwon Cho.")
...
DATA_URL3 = "./pages/nasdaq_nyse_industrial.csv"
#tickers = pd.read_csv()
