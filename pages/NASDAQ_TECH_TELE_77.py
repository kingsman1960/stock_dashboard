...
st.title("NASDAQ Tech & Tele Dashboard")

st.markdown("This streamlit application is using for"
            "monitoring NASDAQ Tech & Telecommunication companies with upperthan medium market Cap (> $ 2 Bil) \n By Youngwon Cho.")
...
DATA_URL2 = "./pages/nasdaq_techundtelelar77.csv"
#tickers = pd.read_csv()
